    ...
    <div className="min-h-screen crystal-pattern crystal-particles relative overflow-hidden">
      ...
      <main className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="text-center mb-12 sm:mb-20 relative">
          <div className="inline-block p-2 rounded-2xl mb-6 sm:mb-8 animate-fade-in crystal-gradient-primary">
            <div className="rounded-xl px-4 sm:px-8 py-2 sm:py-3 shadow-crystal" style={{ background: 'var(--crystal-surface)' }}>
              <span className="text-xs sm:text-sm font-medium crystal-gradient-text" style={{ fontFamily: 'serif' }}>
                ✨ Welcome to Crystal Stakes
              </span>
            </div>
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-6xl font-light mb-4 sm:mb-6 tracking-wide animate-slide-up crystal-gradient-text px-4" style={{ fontFamily: 'serif' }}>
            Stake
            <span className="font-medium crystal-pulse block sm:inline" style={{ fontFamily: 'serif', color: 'var(--crystal-primary-600)' }}> HAPG tokens</span>
          </h2>
          <p className="text-base sm:text-lg lg:text-xl max-w-3xl mx-auto leading-relaxed animate-fade-in delay-300 px-4" style={{ color: 'var(--crystal-text-secondary)', fontFamily: 'serif' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 mb-12 sm:mb-16">
          {/* Stake Card */}
          <div className="group crystal-card p-6 sm:p-8 lg:p-10 animate-fade-in crystal-hover-lift">
            <div className="flex items-center mb-6 sm:mb-8">
              <div className="w-12 sm:w-16 h-12 sm:h-16 rounded-2xl flex items-center justify-center mr-4 sm:mr-6 group-hover:scale-110 transition-transform duration-300 shadow-crystal mobile-touch-target" 
              ...
              <div className="min-w-0 flex-1">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-medium mb-2 truncate" style={{ color: 'var(--crystal-text-primary)', fontFamily: 'serif' }}>Stake Token</h3>
                <p className="text-sm sm:text-base" style={{ color: 'var(--crystal-text-muted)' }}>Begin your staking journey</p>
              </div>
            </div>
            <StakeForm />
          </div>
          ...
          {/* Withdraw Card */}
          <div className="group crystal-card p-6 sm:p-8 lg:p-10 animate-fade-in delay-200 crystal-hover-lift">
            <div className="flex items-center mb-6 sm:mb-8">
              <div className="w-12 sm:w-16 h-12 sm:h-16 rounded-2xl flex items-center justify-center mr-4 sm:mr-6 group-hover:scale-110 transition-transform duration-300 shadow-crystal mobile-touch-target" 
              ...
              <div className="min-w-0 flex-1">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-medium mb-2 truncate" style={{ color: 'var(--crystal-text-primary)', fontFamily: 'serif' }}>Withdraw Token</h3>
                <p className="text-sm sm:text-base" style={{ color: 'var(--crystal-text-muted)' }}>Access your staked tokens</p>
              </div>
            </div>
            <WithdrawForm />
          </div>
          ...
          {/* Claim Rewards Card */}
          <div className="group crystal-card p-6 sm:p-8 lg:p-10 animate-fade-in delay-400 crystal-hover-lift">
            <div className="flex items-center mb-6 sm:mb-8">
              <div className="w-12 sm:w-16 h-12 sm:h-16 rounded-2xl flex items-center justify-center mr-4 sm:mr-6 group-hover:scale-110 transition-transform duration-300 shadow-crystal mobile-touch-target" 
              ...
              <div className="min-w-0 flex-1">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-medium mb-2 truncate" style={{ color: 'var(--crystal-text-primary)', fontFamily: 'serif' }}>Claim Rewards</h3>
                <p className="text-sm sm:text-base" style={{ color: 'var(--crystal-text-muted)' }}>Harvest your earnings</p>
              </div>
            </div>
            <ClaimRewards />
          </div>
          ...
          <div className="group crystal-card p-6 sm:p-8 lg:p-10 animate-fade-in delay-600 crystal-hover-lift">
            <div className="flex items-center mb-6 sm:mb-8">
              <div className="w-12 sm:w-16 h-12 sm:h-16 rounded-2xl flex items-center justify-center mr-4 sm:mr-6 group-hover:scale-110 transition-transform duration-300 shadow-crystal mobile-touch-target" 
              ...
              <div className="min-w-0 flex-1">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-medium mb-2 truncate" style={{ color: 'var(--crystal-text-primary)', fontFamily: 'serif' }}>Emergency Exit</h3>
                <p className="text-sm sm:text-base" style={{ color: 'var(--crystal-text-muted)' }}>Quick withdrawal option</p>
              </div>
            </div>
            <EmergencyWithdraw />
          </div>
        ...
        {/* User Position */}
        <div className="crystal-card p-6 sm:p-8 lg:p-10 transition-all duration-300 animate-fade-in delay-800 crystal-hover-lift">
          <div className="flex items-center mb-6 sm:mb-8">
            <div className="w-3 sm:w-4 h-12 sm:h-16 rounded-full mr-4 sm:mr-6 crystal-gradient-primary"></div>
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-light" style={{ color: 'var(--crystal-text-primary)', fontFamily: 'serif' }}>
        ...
        {/* Transaction History */}
        <div className="mt-12 sm:mt-16 crystal-card p-6 sm:p-8 lg:p-10 transition-all duration-300 animate-fade-in delay-900 crystal-hover-lift">
          <div className="flex items-center mb-6 sm:mb-8">
            <div className="w-3 sm:w-4 h-12 sm:h-16 rounded-full mr-4 sm:mr-6" style={{ background: 'var(--crystal-gradient-secondary)' }}></div>
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-light" style={{ color: 'var(--crystal-text-primary)', fontFamily: 'serif' }}>
              Transaction History
            </h2>
          </div>
        ...
        {/* Subgraph Analytics */}
        <div className="mt-12 sm:mt-16 crystal-card p-6 sm:p-8 lg:p-10 transition-all duration-300 animate-fade-in delay-1000 crystal-hover-lift">
          <div className="flex items-center mb-6 sm:mb-8">
            <div className="w-3 sm:w-4 h-12 sm:h-16 rounded-full mr-4 sm:mr-6" style={{ background: 'var(--crystal-gradient-secondary)' }}></div>
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-light" style={{ color: 'var(--crystal-text-primary)', fontFamily: 'serif' }}>
              Network Analytics
      ...
      {/* Footer */}
      <footer className="relative crystal-glass border-t mt-12 sm:mt-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
          <div className="text-center">
            <p className="text-sm sm:text-base font-light crystal-gradient-text" style={{ fontFamily: 'serif' }}>
              ✨ Crystal Stakes - Where elegance meets DeFi ✨
            </p>
            <p className="text-xs sm:text-sm mt-2 font-medium" style={{ color: 'var(--crystal-primary-600)' }}>
