...
export function ProtocolStats() {
  ...
  const { data: currentRewardRate, isLoading: isRewardRateLoading } = useReadContract({
    address: stakingContractAddress,
    abi: stakingContractABI,
    functionName: 'currentRewardRate',
  });

  const { data: totalRewards, isLoading: isTotalRewardsLoading } = useReadContract({
    address: stakingContractAddress,
    abi: stakingContractABI,
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {isTotalStakedLoading ? (
          <CardLoader message="Loading total staked..." />
        ) : (
        ...
        {isTotalRewardsLoading ? (
          <CardLoader message="Loading rewards..." />
        ) : (
